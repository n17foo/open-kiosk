...
const PlatformSetupScreen: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Success',
        `Connected to ${platformConfig.name} with ${selectedPaymentProcessor} payments`,
    ...
    <Screen>
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.subtitle}>
          Choose your ecommerce platform, payment processor and configure the connection
        </Text>
        ...
        <View style={styles.platformSection}>
          ...
          {PAYMENT_PROCESSORS.map((processor) => (
            <TouchableOpacity
              ...
              style={[
                styles.platformOption,
                selectedPaymentProcessor === processor.type && styles.selectedPlatform,
              ]}
            ...
            >
              ...
              {selectedPaymentProcessor === processor.type && (
                <Text style={styles.checkmark}>✓</Text>
              )}
            </TouchableOpacity>
          ))}
        ...
        <View style={styles.actions}>
          ...
          <KioskButton
            ...
            onPress={handleSave}
            loading={isLoading}
            disabled={!selectedPlatform || !selectedPaymentProcessor}
          />
        </View>
      </ScrollView>
    </Screen>
