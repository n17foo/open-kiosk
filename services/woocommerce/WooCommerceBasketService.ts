...
export class WooCommerceBasketService implements BasketService {
  ...
  async applyDiscount(code: string): Promise<Basket> {
    // TODO: Implement discount application with WooCommerce coupons API
  ...
  private recalculateTotals(): void {
    ...
    this.basket.tax.amount = Math.round(subtotal * 0.2);
