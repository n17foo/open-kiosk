...
export class OrderConverter {
   ...
   */
  static toWooCommerceOrder(basket: Basket, _platformType: PlatformType = 'woocommerce'): WooCommerceOrderData {
    return {
   ...
   */
  static toShopifyOrder(basket: Basket, _platformType: PlatformType = 'shopify'): ShopifyOrderData {
    return {
      email: 'kiosk@example.com',
   ...
   */
  static toMagentoOrder(basket: Basket, _platformType: PlatformType = 'magento'): MagentoOrderData {
    return {
   ...
   */
  static convertOrder(basket: Basket, platformType: PlatformType): any {
    switch (platformType) {
      case 'woocommerce':
