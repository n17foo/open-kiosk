...
import { View, Text, TouchableWithoutFeedback, ImageBackground, Animated, Dimensions, StyleSheet, ActivityIndicator } from 'react-native';
        ...
        >
          ...
          <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
            <View style={styles.logoContainer}>
              ...
              <Text style={[styles.brandName, splashData.primaryColor && { color: splashData.primaryColor }]}>{splashData.brandName}</Text>
            </View>

            <View style={styles.heroText}>
              <Text style={[styles.title, splashData.primaryColor && { color: splashData.primaryColor }]}>{splashData.title}</Text>
