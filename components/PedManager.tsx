...
export const PedManager: React.FC<PedManagerProps> = ({ paymentMethod, amount, onPaymentComplete, onCancel }) => {
      ...
      <View style={styles.body}>
        ...
        {pedState.cardData && (
          <View style={styles.cardInfo}>
            <Text style={styles.cardInfoText}>Card: **** **** **** {pedState.cardData.lastFour}</Text>
            <Text style={styles.cardInfoText}>Name: {pedState.cardData.cardholderName}</Text>
          </View>
        )}

        {pedState.phase === 'processing' && <ActivityIndicator size="large" color="#007bff" style={styles.spinner} />}
      </View>
